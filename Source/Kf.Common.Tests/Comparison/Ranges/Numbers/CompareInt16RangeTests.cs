...
namespace Kf.Common.Tests.Comparison.Ranges.Numbers
{
    public class CompareInt16RangeTests
    {
        ...
        {
            IRange<short> range = new Int16Range(0, 100, RangeComparisonOptions.New().WithMinimumExcluded().Build());
            var sut = new CompareInt16Range();
        ...
        {                        
            IRange<short> range = new Int16Range(0, 100, RangeComparisonOptions.New().WithMaximumExcluded().Build());
            var sut = new CompareInt16Range();
