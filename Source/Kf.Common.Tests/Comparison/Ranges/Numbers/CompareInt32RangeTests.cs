...
namespace Kf.Common.Tests.Comparison.Ranges.Numbers
{
    public class CompareInt32RangeTests
    {
        ...
        {
            IRange<int> range = new Int32Range(0, 100, RangeComparisonOptions.New().WithMinimumExcluded().Build());
            var sut = new CompareInt32Range();
        ...
        {                        
            IRange<int> range = new Int32Range(0, 100, RangeComparisonOptions.New().WithMaximumExcluded().Build());
            var sut = new CompareInt32Range();
